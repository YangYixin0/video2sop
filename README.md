...
这个项目是一个Web App，具有AI视频理解能力，可以将实验室仪器或实验教学视频转换为标准操作流程（standard operational procedure，SOP）文档。

这个项目一般是部署在一个服务器上，然后用户通过浏览器访问。如果你不会部署，可以请求你所在的组织的IT部门去部署，这对他们来说很简单。
