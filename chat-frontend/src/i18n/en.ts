...
export const en: TranslationDict = {
  common: {
    ...
    upload_to_show_records: 'Upload a video to see records',
...
export const enExporter = {
  exporter: {
    ...
    txt_desc: 'Suitable for editing and publishing to platforms such as',
    html_title: 'HTML Associated (.html)',
