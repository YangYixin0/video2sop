...
export const zhUploader = {
  uploader: {
    ...
    upload_1080p_tooltip: '1080p的视频理解结果可能比720p更准确一点点',
    upload_and_compress_720p: '上传并压缩至720p',
    upload_720p_tooltip: '720p的压缩速度比1080p快一些',
    remove: '移除',
    or: '或者',
    load_example: '加载示例视频',
    upload_ok: '上传完成！',
...
export const zhExporter = {
  exporter: {
    ...
    txt_title: '纯文本格式 (.txt)',
    txt_desc1: '适合随意编辑。',
    txt_desc2: '适合发布于开放获取平台，例如',
    html_title: '超文本格式 (.html)',
    html_desc1: '支持视频播放，适合实验室内部使用。',
    html_desc2: '视频文件需与HTML文件在同一目录下，然后在HTML文件开头配置视频文件。',
    html_desc3_part1: '如果要修改样式，可以将HTML文件的内容（记事本打开）复制到',
    html_desc3_link: 'Qwen网页预览模式',
    html_desc3_part2: '，要求生成预览再与Qwen协作修改。',
    exporting: '导出中...',
    export_txt: '导出TXT',
    export_html: '导出HTML',
    export_failed: '导出失败',
